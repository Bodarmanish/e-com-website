...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="{{ url('/admin/addproduct') }}" class="current">Products</a><a href="{{ url('/admin/addproduct') }}" class="current">Add Products</a> </div>
    <h1>Products</h1>
  </div>                        
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/addproduct') }}" name="add_product" id="add_product" novalidate="novalidate">
            	{{ csrf_field()}}
